...
37 multi((filter(g<1,i,1>,a<1,i,1>,a<1,i,2>)),#t,{g<1,1,1>/g2,a<1,1,1>/a1,a<1,1,2>/a3},{a<1,i+1,1>/a<1,i,2>},{g<1,L,1>/g4,a<1,L,1>/a5,a<1,L,2>/a7}) 1:l1+1:#t 3
38 filter(g5,a7,a9) l1+2 3
39 sift(a9,a10) l1+2 3
40 len(a10,g7) 0 #f
